        ...
        <>
            <div className='container  mt-3 p-1 rounded-3'>
                <div className='d-flex flex-column text-center'>
                    <div>
                        <img style={{ width: '120px' }} className='rounded-circle' src="https://images.unsplash.com/photo-1633332755192-727a05c4013d?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxzZWFyY2h8MXx8dXNlcnxlbnwwfHwwfHw%3D&auto=format&fit=crop&w=500&q=60" alt="" />
                    </div>
                    <div className='w-100'>
                        <h4 className={ProfileStyle.userName}>{user?.username}</h4>
                       <h5 style={{}} className={ProfileStyle.email}>{user?.email}</h5>
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form>
                                <input placeholder='enter name' type="text" className='form-control mt-3' required/>
                                <input placeholder='enter email' type="email" className='form-control my-3' required/>
