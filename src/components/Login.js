...
const Login = () => {
  ...
  fetch('https://banaosocialmedia.herokuapp.com/users')
    .then((res) => res.json())
  ...
  //fetch
  //  let url =`
  //  https://banaosocialmedia.herokuapp.com/usered?username=${username}`
  // useEffect(()=>{

  //     fetch(` https://banaosocialmedia.herokuapp.com/useredd?username=${username}`)
  // .then((res)=>res.json())
  // .then((data)=>
  //     setUser(data?.[0])
  ...
  // //     fetch(`https://banaosocialmedia.herokuapp.com/usered?username=${username}`)
  // //  .then((res)=>res.json())
  ...
  const ForgetPass = (e) => {
    ...
    fetch(`https://banaosocialmedia.herokuapp.com/userd?email=${forgetuser}`)
      .then((res) => res.json())
      .then((data) => {
        setFound(data);
      });
    ...
    fetch(`https://banaosocialmedia.herokuapp.com/useres?email=${forgetuser}`, {
      method: 'PUT',
      headers: {
